	...
	return (
		<section className="w-full min-h-screen relative overflow-hidden bg-[#faf9f7]">
			...
			<div className="relative z-10 flex flex-col items-center justify-start pt-[160px] lg:pt-[140px] md:pt-[120px] sm:pt-[90px] xm:pt-[80px] px-[24px] sm:px-[20px] xm:px-[16px] pb-0">
				...
				>
					Sidestuff is a live ecosystem where startups are actively built by real teams. We connect founders, contributors, and investors through execution, collaboration, and real work — not pitch decks.
				</motion.p>
				...
				>
					...
					>
						<Image
							...
							alt="Sidestuff platform dashboard preview"
							fill
