  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="space-y-4">
        <TextArea
          label="What's the one problem you're hoping Sidestuff solves for you?"
        ...
        <TextArea
          label="What would make you recommend Sidestuff to someone else?"
        ...
        <RadioCardGroup
          label="How soon are you looking to use Sidestuff?"
          name="timing"
