...
export default function Footer() {
	...
	const companyLinks = [
		...
		{ id: 3, title: "Contact", href: "mailto:hello@Katagoge.com" },
	];

	const socialLinks = [
		{ id: 1, title: "X (Twitter)", href: "https://x.com/Katagoge", external: true },
		{ id: 2, title: "LinkedIn", href: "https://linkedin.com/company/Katagoge", external: true },
		{ id: 3, title: "Instagram", href: "https://instagram.com/Katagoge", external: true },
	];
				...
				<div className="h-full flex flex-col justify-between sm:w-full xm:w-full w-1/2 pt-10 sm:pt-0 xm:pt-0">
					<div>
						...
						<div className="pt-[100px] sm:pt-16 xm:pt-12 flex flex-col gap-y-[10px]">
							...
							<LinkHover
								title="hello@Katagoge.com"
								href="mailto:hello@Katagoge.com"
				...
				<div className="flex flex-col gap-4 xm:gap-2">
					<p className="text-xl font-black uppercase tracking-tight text-[#212121]" style={{ fontFamily: "'Unbounded', sans-serif" }}>
						...
						<p className="paragraph font-medium font-NeueMontreal text-secondry opacity-40">
							© 2026 Katagoge. All rights reserved.
						</p>
				</div>
